...
the average distance between midpoint and each array, and exporting video.
...
* Every 100 ms block:
    ...
    9. Export the resulting animation to an MP4 file.
"""
...
def main() -> None:
    ...
    with open(CSV_PATH, "w", newline="") as csv_file:
        ...
        # Use FFMpegWriter with a reasonable bitrate (e.g., 2000 kbps)
