...
DETECT_F = 300.0                 # Center frequency for threshold (Hz)
BW = 200.0                       # Bandwidth (Hz)
THRESH_DB = 33.0                # Threshold in dB

# Azimuth/elevation grid for beamforming
azimuth_range = np.arange(-180, 181, 10)   # –180…+180 in 1° steps
elevation_range = np.arange(0, 91, 10)     # 0…90 in 1° steps
...
if __name__ == "__main__":
    wav_files = [
        "/Users/30068385/OneDrive - Western Sydney University/recordings/Helicop/30_05_25/1_Left/Macarthur/left.wav"
    ]
    for wav in wav_files:
        process_airplane_with_threshold(
            ...
            #start_time=3420.0,  # absolute start at 3420 s
            start_time=1000.0,
            #end_time=3498.0     # absolute end at 3498 s
            end_time = 3570.0
        )
