...
if __name__ == "__main__":
    wav_files = ["/Users/30068385/OneDrive - Western Sydney University/recordings/Helicop/30_05_25/2_Right/Macarthur/right.wav"]
    for wav in wav_files:
        process_audio_segment_to_video(
            ...
            start_time=3420.0,    # start at 5 seconds
            end_time=3498.0      # end at 20 seconds
        )
