...
def process_audio_and_export_two_plots(
    wav_filename: str,
    heatmap_mov: str            = "beamforming_heatmap.mov",
    rect_mov:     str            = "beamforming_rectangle.mov",
    fps:          int            = 10,
    dpi:          int            = 200,
...
if __name__ == "__main__":
    input_wav     =         "/Users/30068385/OneDrive - Western Sydney University/recordings/Helicop/30_05_25/1_Left/Macarthur/left.wav"
