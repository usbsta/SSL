...
skip_seconds = 3.1  # Seconds to skip at the beginning of the audio

# Define beamforming grid for azimuth and elevation angles
azimuth_range = np.arange(-180, 181, 10)  # Azimuth from -180° to 180° in 4° steps
elevation_range = np.arange(0, 91, 10)      # Elevation from 0° to 90° in 4° steps

# Initialize microphone positions and compute the nu‹mber of channels
